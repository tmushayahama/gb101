...
<div class="gb-form-header gb-form-header-2">
 <div class="row">
  <div class="col-lg-10 col-md-10 col-sm-10 gb-xs-10 gb-no-padding">
   <p class="gb-form-heading gb-ellipsis">Add a note</p>
  </div>
...
<div class="gb-form-body row">
 ...
 <div class="form-group gb-hide row">
  <?php echo $form->hiddenField($noteModel, 'parent_note_id', array('id' => 'gb-note-form-parent-id-input')); ?>
 </div>
 <div class="form-group row gb-no-margin">
  <?php echo $form->textArea($noteModel, 'description', array('id' => 'gb-note-form-description-input', 'class' => ' form-control col-lg-12 col-md-12 col-sm-12 col-xs-12', 'maxlength' => 150, 'placeholder' => 'Note max 150 characters, just like twitter', 'rows' => '3')); ?>
