 ...
 <div class="col-lg-11 col-md-11 col-sm-11 gb-no-padding">
  <div class="row gb-row-display ">
   ...
   <div class="col-lg-11 col-sm-11 col-xs-12 gb-no-padding gb-no-margin">
    ...
    <div class="row">
     <?php
     $this->renderPartial('note.views.note.forms._note_child_form', array(
       "formId" => "gb-note-form-" . $note->id,
       "actionUrl" => Yii::app()->createUrl("note/note/addNoteReply", array()),
       "prependTo" => "#gb-skill-notes-reply-" . $note->id,
       "noteModel" => new Note(),
       "parentValue" => $note->id,
