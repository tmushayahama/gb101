        ...
        <li class="col-lg-12 col-sm-12 col-xs-12 gb-padding-none">
          <a class="row" href="#gb-contributor-person-pane" data-toggle="tab"
            ...
            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 gb-padding-none pull-left">
              <img class="gb-icon-2 col-lg-2 gb-padding-none" src="<?php echo Yii::app()->request->baseUrl . "/img/profile_pic/" . $mentorshipContributor->contributor->profile->avatar_url; ?>" alt="">
              <div class="col-lg-9 gb-padding-none"><p class="gb-ellipsis "><?php echo $mentorshipContributor->contributor->profile->firstname . " " . $mentorshipContributor->contributor->profile->lastname; ?></p></div>
            </div>
            <i class="glyphicon glyphicon-chevron-right pull-right"></i>
          </a>
        </li>
      ...
      <?php foreach ($mentorshipObservers as $mentorshipObserver): ?>
        <li class="col-lg-12 col-sm-12 col-xs-12 gb-padding-none">
          <a class="row" href="#gb-contributor-person-pane" data-toggle="tab"
            ...
            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 gb-padding-none pull-left">
              <img class="gb-icon-2 col-lg-2 gb-padding-none" src="<?php echo Yii::app()->request->baseUrl . "/img/profile_pic/" . $mentorshipObserver->observer->profile->avatar_url; ?>" alt="">
              <div class="col-lg-9 gb-padding-none"><p class="gb-ellipsis "><?php echo $mentorshipObserver->observer->profile->firstname . " " . $mentorshipObserver->observer->profile->lastname; ?></p></div>
            </div>
            <i class="glyphicon glyphicon-chevron-right pull-right"></i>
          </a>
        </li>
