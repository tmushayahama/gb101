...
<div class="col-lg-12 col-sm-12 col-xs-12 gb-no-padding gb-no-margin">
 <div class="row">
  ...
  <h5 class="gb-heading-6 col-lg-12 col-sm-12 col-xs-12">
   ...
   <div class="col-lg-1 col-sm-1 col-xs-1 gb-no-padding">
    <i class="pull-right"><?php echo $mentorshipDiscussionsCount; ?></i>
   </div>
  </h5>
 ...
 <div id="gb-mentorship-discussions">
  <?php
  $this->renderPartial('mentorship.views.mentorship.activity.discussion._mentorship_discussions', array(
