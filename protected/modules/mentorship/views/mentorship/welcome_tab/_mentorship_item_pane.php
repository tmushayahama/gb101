 ...
 <div class="gb-background-white row">
  ...
  <ul id="" class="gb-icon-top-nav-1 row gb-nav">
   ...
   <li class="col-lg-2 col-sm-2 col-xs-12">
    <a  class="gb-link" data-toggle="tab"
        data-gb-url="<?php echo Yii::app()->createUrl("mentorship/mentorshipTab/mentorshipTodos", array('mentorshipId' => $mentorship->id)); ?>"
        data-gb-target-pane-id="#gb-mentorship-item-tab-pane">
   ...
   <li class="col-lg-2 col-sm-2 col-xs-12">
    <a  class="gb-link" data-toggle="tab"
        data-gb-url="<?php echo Yii::app()->createUrl("mentorship/mentorshipTab/mentorshipComments", array('mentorshipId' => $mentorship->id)); ?>"
        data-gb-target-pane-id="#gb-mentorship-item-tab-pane">
   ...
   <li class="col-lg-2 col-sm-2 col-xs-12">
    <a  class="gb-link" data-toggle="tab"
        data-gb-url="<?php echo Yii::app()->createUrl("mentorship/mentorshipTab/mentorshipNotes", array('mentorshipId' => $mentorship->id)); ?>"
        data-gb-target-pane-id="#gb-mentorship-item-tab-pane">
   ...
   <li class="col-lg-2 col-sm-2 col-xs-12">
    <a  href="#gb-mentorship-item-contributors-pane" data-toggle="tab"
        data-gb-url="<?php echo Yii::app()->createUrl("mentorship/mentorshipTab/mentorshipContributors", array('mentorshipId' => $mentorship->id)); ?>"
        data-gb-target-pane-id="#gb-mentorship-item-tab-pane">
   ...
   <li class="gb-more-target gb-hide col-lg-2 col-sm-2 col-xs-12">
    <a  class="gb-link" data-toggle="tab"
        data-gb-url="<?php echo Yii::app()->createUrl("mentorship/mentorshipTab/mentorshipDiscussions", array('mentorshipId' => $mentorship->id)); ?>"
        data-gb-target-pane-id="#gb-mentorship-item-tab-pane">
   ...
   <li class="gb-more-target gb-hide col-lg-2 col-sm-2 col-xs-12">
    <a  class="gb-link" data-toggle="tab"
        data-gb-url="<?php echo Yii::app()->createUrl("mentorship/mentorshipTab/mentorshipQuestionnaires", array('mentorshipId' => $mentorship->id)); ?>"
        data-gb-target-pane-id="#gb-mentorship-item-tab-pane">
   ...
   <li class="gb-more-target gb-hide col-lg-2 col-sm-2 col-xs-12">
    <a  class="gb-link" data-toggle="tab"
        data-gb-url="<?php echo Yii::app()->createUrl("mentorship/mentorshipTab/mentorshipWeblinks", array('mentorshipId' => $mentorship->id)); ?>"
        data-gb-target-pane-id="#gb-mentorship-item-tab-pane">
