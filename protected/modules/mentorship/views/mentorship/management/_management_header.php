...
<div class="container">
  <div id="gb-profile-header" class="row">
    <div class="col-lg-2 col-sm-2 col-xs-2 gb-people-heading-row">
      <img src="<?php echo Yii::app()->request->baseUrl . "/img/profile_pic/" . $mentorship->creator->profile->avatar_url; ?>" class="gb-profile-img" alt="">
    </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 gb-padding-thinner">
          <div class="thumbnail">
            <div class="caption text-center">
              ...
              <h1 class="gb-number text-success"><?php echo Skill::getSkillCount(Level::$LEVEL_CATEGORY_SKILL, null, $mentorship->creator_id); ?></h1>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 gb-padding-thinner">
          <div class="thumbnail">
            <div class="caption text-center">
              ...
              <h1 class="gb-number text-success"><?php echo Mentorship::getMentorshipCount(null, $mentorship->creator_id); ?></h1>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 gb-padding-thinner">
          <div class="thumbnail">
            <div class="caption text-center">
              ...
              <h1 class="gb-number text-success"><?php echo Page::getPagesCount($mentorship->creator_id); ?></h1>
