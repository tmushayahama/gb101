        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 gb-padding-thinner">
          <div class="thumbnail">
            <div class="caption text-center">
              ...
              <h1 class="gb-number text-success"><?php echo SkillList::getSkillListCount(Level::$LEVEL_CATEGORY_SKILL, null, $mentorship->owner_id); ?></h1>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 gb-padding-thinner">
          <div class="thumbnail">
            <div class="caption text-center">
              ...
              <h1 class="gb-number text-success"><?php echo Mentorship::getMentorshipCount(null, $mentorship->owner_id); ?></h1>
