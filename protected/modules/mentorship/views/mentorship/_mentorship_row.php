  ...
  <div class="row ">
    ...
    <div class="panel panel-default col-lg-10 col-sm-10 col-xs-10 gb-mentorship-top-border gb-no-padding">
      ...
      <div class="panel-body skill-commitment-title">
        <p><a class="mentorship-title" href="<?php echo Yii::app()->createUrl('mentorship/mentorship/mentorshipManagement', array('mentorshipId' => $mentorship->id)); ?>"><?php echo $mentorship->title; ?></a>   
        ...
        <?php if (!Yii::app()->user->isGuest): ?>
          ...
          <?php if ($mentorship->owner->id == Yii::app()->user->id): ?>
            <div class="row">
              <div class="pull-right">
                ...
                <a href="<?php echo Yii::app()->createUrl('mentorship/mentorship/mentorshipManagement', array('mentorshipId' => $mentorship->id)); ?>" class="btn btn-link"><i class="glyphicon glyphicon-arrow-right"></i></a>
              </div>
            </div>
          <?php elseif ($pendingRequest != null): ?>
            ...
            <div class="row gb-padding-thin">
              ...
              <div class="pull-right">
                <a href="<?php echo Yii::app()->createUrl('mentorship/mentorship/mentorshipManagement', array('mentorshipId' => $mentorship->id)); ?>" class="btn btn-xs btn-link"><i class="glyphicon glyphicon-arrow-right"></i></a>
              </div>
            </div>
          <?php else: ?>
            <div class="row">
