    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gb-no-padding">
      <div class="tab-content row">
        <div class="tab-pane active" id="goal-mentorship-all-pane">
          <div class="gb-home-left-nav col-lg-4 col-md-4 col-sm-4 col-xs-12 gb-background-blue-1 gb-no-padding">
            <br>
          ...
          <div class="col-lg-7 col-md-8 col-sm-8 col-xs-12 gb-no-padding gb-blue-background ">
            <br>
            <div class="row">
