...
/**
 * This is the model class for table "{{mentorship_type}}".
 *
 * The followings are the available columns in table '{{mentorship_type}}':
 * @property integer $id
 ...
 * @property Bank[] $banks
 */
class MentorshipType extends CActiveRecord {

  public static $CATEGORY_MENTORSHIP = "mentorship";
  
  public static $FORM_TYPE_MENTORSHIP_HOME = 1;
   ...
   * @return MentorshipType the static model class
   */
  ...
  public function relations() {
    ...
    return array(
     'mentorships' => array(self::HAS_MANY, 'Mentorship', 'type_id'),
