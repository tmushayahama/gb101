...
class MentorshipAnswer extends CActiveRecord
{
  public static function getAnswers($mentorshipId, $questionId, $isMentor) {
	...
	public function rules()
	{
		...
		return array(
			array('questionee_id, mentorship_id, mentorship_question_id', 'required'),
			...
			array('id, questionee_id, mentorship_id, mentorship_question_id, goal_id, description, level, status', 'safe', 'on'=>'search'),
		);
	}
