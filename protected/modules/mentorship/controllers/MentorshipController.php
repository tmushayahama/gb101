  ...
  public function actionMentorshipManagement($mentorshipId) {
    ...
    if (Yii::app()->user->isGuest) {
      ...
      $this->render('mentorship_management_guest', array(
       ...
       'mentorshipMentorsEnrolled' => Mentorship::getMentorships($mentorship->id, null, Mentorship::$TYPE_NEED_MENTOR),
       'mentorshipMenteesEnrolled' => Mentorship::getMentorships($mentorship->id, null, Mentorship::$TYPE_NEED_MENTEE),
      ...
      if ($mentorship->owner->id == Yii::app()->user->id) {
        $this->render('mentorship_management_owner', array(
         ...
         'mentorshipAssignmentsEnrolled' => Mentorship::getMentorships($mentorship->id, null, Mentorship::$TYPE_MENTORSHIP_ASSIGN),
         'mentorshipTypeName' => Mentorship::getMentorshipTypeName($mentorship->type),
         'mentorshipMentorRequests' => Notification::getRequestStatus(array(Notification::$NOTIFICATION_MENTOR_REQUEST_OWNER), $mentorship->id, null, true),
         'mentorshipMenteeRequests' => Notification::getRequestStatus(array(Notification::$NOTIFICATION_MENTEE_REQUEST_OWNER), $mentorship->id, null, true),
