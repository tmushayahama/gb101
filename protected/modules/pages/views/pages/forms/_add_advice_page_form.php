...
$form = $this->beginWidget('CActiveForm', array(
 ...
 'htmlOptions' => array(
  ...
  'data-gb-url' => Yii::app()->createUrl("pages/pages/addAdvicePage", array()),
  ...
  <div class="col-lg-12 col-sm-12 col-xs-12 gb-no-padding">
    ...
    <div class="form-group row">
      <div class="col-lg-4 col-sm-4 col-xs-12 gb-no-padding">
        <?php echo $form->textField($advicePageModel, 'skills', array('id' => 'gb-advice-page-skills-input', 'class' => 'btn  form-control col-lg-12 col-sm-12 col-xs-12', 'placeholder' => 'Select Number', 'readonly' => true)); ?>
        <?php echo $form->error($advicePageModel, 'skills'); ?>
      </div>
...
<div class="modal-footer">
  <div class="pull-right btn-group">
    ...
    <?php echo CHtml::submitButton('Submit', array('id' => 'gb-advice-page-btn', 'source' => 'home-page', 'class' => 'gb-submit-form btn btn-primary', 'data-gb-action' => Type::$AJAX_RETURN_ACTION_REDIRECTS)); ?>
  </div>
</div>
<?php $this->endWidget(); ?>
