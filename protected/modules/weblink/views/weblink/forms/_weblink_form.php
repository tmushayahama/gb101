...
<div class="gb-form-header gb-form-header-2">
 <div class="row">
  <h3 class="gb-form-heading pull-left">Add Weblink</h3>
...
<div class="gb-form-body row">
 ...
 <div class="form-group gb-hide row">
  <?php echo $form->hiddenField($weblinkModel, 'parent_weblink_id', array('id' => 'gb-weblink-form-parent-id-input')); ?>
 </div>
 <div class="form-group row gb-no-margin">
  <?php echo $form->textArea($weblinkModel, 'description', array('id' => 'gb-weblink-form-description-input', 'class' => ' form-control col-lg-12 col-md-12 col-sm-12 col-xs-12', 'maxlength' => 150, 'placeholder' => 'Weblink max 150 characters, just like twitter', 'rows' => '3')); ?>
