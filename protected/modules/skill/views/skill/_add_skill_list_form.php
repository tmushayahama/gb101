...
$form = $this->beginWidget('CActiveForm', array(
 ...
 'htmlOptions' => array(
  ...
  'gb-add-url' => Yii::app()->createUrl("skill/skill/addskilllist", array('connectionId' => 0, 'source' => "home", 'type' => SkillList::$TYPE_SKILL)),
  'gb-edit-url' => Yii::app()->createUrl("skill/skill/editskilllist", array('connectionId' => 0, 'source' => "home", 'type' => SkillList::$TYPE_SKILL)),
