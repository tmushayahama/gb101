...
?>
<?php if ($skillListItem->user_id == Yii::app()->user->id) : ?>
  <div class="gb-commitment-post">
    <span class='gb-top-heading gb-heading-left'>Skill Commitment</span>
    <span class='gb-top-heading gb-heading-right'><?php echo $skillListItem->type->type ?></span>
...
<?php else: ?>
  <div class="gb-commitment-post">
    <span class='gb-top-heading gb-heading-left'>Skill Commitment</span>
    <span class='gb-top-heading gb-heading-right'><?php echo $skillListItem->goal->type->type; ?></span>
    <div class="gb-post-title ">
      <span class="span1">
        <img href="/profile" src="<?php echo Yii::app()->request->baseUrl; ?>/img/gb_avatar.jpg" class="gb-post-img img-polariod" alt="">
      </span>
      <span class="span9">
        <a><strong><?php echo $skillListItem->owner->profile->firstname . " " . $skillListItem->owner->profile->lastname ?></strong></a><br>
        <small><a><i>Shared to <?php echo $connection_name ?></i></a> - <a>12/03/13</a></small>								
      </span>
      <span class="span2">
        <h4 class="pull-right"><?php echo $skillListItem->goal->points_pledged ?>
    ...
    <div class="gb-post-content row">
      ...
      <span class=" span4">
        <ul class="gb-post-action pull-righ nav nav-stacked">
          <li><h6><a class="gb-request-monitee-modal-trigger" skill-id="<?php echo $skillListItem->id; ?>"><i class="icon icon-eye-open"></i>Monitor</a> <a class="badge badge-info pull-right">0</a></h6></li>
          <li><h6><a class="gb-request-menteeship-modal-trigger" skill-id="<?php echo $skillListItem->id; ?>"><i class="icon icon-plane"></i>Mentor</a> <a class="badge badge-info pull-right">0</a></h6></li>
