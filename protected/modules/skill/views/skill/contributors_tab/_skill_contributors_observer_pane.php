 ...
 */
?>
<div class="gb-skill-gained" skill-id="<?php echo $skillObserver->skill_id; ?>">
  <div class="row">
    ...
    <div class="panel panel-default gb-padding-none gb-skill-gained-top-border col-lg-10 col-sm-10 col-xs-12">
