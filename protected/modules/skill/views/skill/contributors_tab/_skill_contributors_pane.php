        ...
        <li class="col-lg-12 col-sm-12 col-xs-12 ">
          <a class="row" href="#gb-contributor-person-pane" data-toggle="tab"
            ...
            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11  pull-left">
              <img class="gb-icon-2 col-lg-2 " src="<?php echo Yii::app()->request->baseUrl . "/img/profile_pic/" . $skillContributor->contributor->profile->avatar_url; ?>" alt="">
              <div class="col-lg-9 "><p class="gb-ellipsis "><?php echo $skillContributor->contributor->profile->firstname . " " . $skillContributor->contributor->profile->lastname; ?></p></div>
            </div>
            <i class="glyphicon glyphicon-chevron-right pull-right"></i>
          </a>
        </li>
      ...
      <?php foreach ($skillObservers as $skillObserver): ?>
        <li class="col-lg-12 col-sm-12 col-xs-12 ">
          <a class="row" href="#gb-contributor-person-pane" data-toggle="tab"
            ...
            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11  pull-left">
              <img class="gb-icon-2 col-lg-2 " src="<?php echo Yii::app()->request->baseUrl . "/img/profile_pic/" . $skillObserver->observer->profile->avatar_url; ?>" alt="">
              <div class="col-lg-9 "><p class="gb-ellipsis "><?php echo $skillObserver->observer->profile->firstname . " " . $skillObserver->observer->profile->lastname; ?></p></div>
            </div>
            <i class="glyphicon glyphicon-chevron-right pull-right"></i>
          </a>
        </li>
