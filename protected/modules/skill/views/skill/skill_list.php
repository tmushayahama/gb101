  ...
  <div id="main-container">
    <div class="row-fluid">
      ...
      <ul id="sidebar-selector">
        ...
        <li class="active" id="sidebar-marketplace"><a href="<?php echo Yii::app()->createUrl("skill/skill/skillhome", array()); ?>" data-asset-type="marketplace"><div class="icon icon-marketplace"></div><br>Goals</a></li>
      ...
      <div id="gb-home-container" class="span9">
        ...
        <div class="gb-commitment-post rm-row">
          <span class='gb-top-heading gb-heading-left'>Skill Item <?php echo $skill->id ?></span>
          ...
          <div class="gb-post-content">
            <span class="span8">
              <h5 class="skill-commitment-title"></h5>
              <div class="span12">
                <span class="span1"><i class="icon icon-align-justify"></i></span>
                <span class="span9"><p class="skill-commitment-description">
