...
<div class="container">
 <br>
 <h4 class="gb-heading-2">Skill Browse</h4>
 <div class="row">
  <div class="gb-home-left-nav col-lg-3 col-md-3 col-sm-12 col-xs-12 gb-no-padding">
   <ul class="gb-side-nav-1">
    <li class="active col-lg-12 col-sm-12 col-xs-12 gb-no-padding">
     <a class="gb-link"
        data-gb-url="<?php echo Yii::app()->createUrl("skill/skill/skillLevelSearch", array()); ?>"
        data-gb-target-pane-id="#gb-search-tab-pane">
      <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 gb-no-padding pull-left">
       <div class="col-lg-12 gb-no-padding"><p class="gb-ellipsis ">Category</p></div>
      </div>
    ...
    <li class="col-lg-12 col-sm-12 col-xs-12 gb-no-padding">
     <a class="gb-link"
        ...
        data-gb-target-pane-id="#gb-search-tab-pane">
      <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 gb-no-padding pull-left">
       <div class="col-lg-12 gb-no-padding"><p class="gb-ellipsis ">Level</p></div>
      </div>
      <i class="glyphicon glyphicon-chevron-right pull-right"></i>
     </a>
    </li>
    <li class="col-lg-12 col-sm-12 col-xs-12 gb-no-padding">
     <a class="gb-link"
        ...
        data-gb-target-pane-id="#gb-search-tab-pane">
      <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 gb-no-padding pull-left">
       <div class="col-lg-12 gb-no-padding"><p class="gb-ellipsis ">Tags</p></div>
      </div>
      <i class="glyphicon glyphicon-chevron-right pull-right"></i>
     </a>
    </li>
    <li class="col-lg-12 col-sm-12 col-xs-12 gb-no-padding">
     <a class="gb-link"
        ...
        data-gb-target-pane-id="#gb-search-tab-pane">
      <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 gb-no-padding pull-left">
       <div class="col-lg-12 gb-no-padding"><p class="gb-ellipsis ">People</p></div>
      </div>
      <i class="glyphicon glyphicon-chevron-right pull-right"></i>
     </a>
    </li>
    <li class="col-lg-12 col-sm-12 col-xs-12 gb-no-padding">
     <a class="gb-link"
        ...
        data-gb-target-pane-id="#gb-search-tab-pane">
      <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 gb-no-padding pull-left">
       <div class="col-lg-12 gb-no-padding"><p class="gb-ellipsis ">Keyword</p></div>
      </div>
      <i class="glyphicon glyphicon-chevron-right pull-right"></i>
     </a>
    </li>
