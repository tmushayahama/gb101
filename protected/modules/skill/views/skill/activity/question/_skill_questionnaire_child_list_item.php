...
<div class="gb-post-entry gb-question-list-item row gb-discussion-title-side-border" skill-question-id="<?php echo $skillQuestionChild->id; ?>"
     gb-source-pk-id="<?php echo $skillQuestionChild->question_id; ?>" gb-data-source="<?php echo Type::$SOURCE_TODO; ?>">
