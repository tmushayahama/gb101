  ...
  <div class="col-lg-10 col-sm-10 col-xs-10 panel panel-default gb-no-padding gb-discussion-title-side-border">
    <div class="panel-body">
      ...
      <div class="row gb-panel-display">
        <p>
          ...
          <span class="gb-display-attribute" gb-control-target="#gb-answer-question-form-description"><?php echo $answer->skill_answer; ?></span>
        </p>
      </div>
    </div>
    <div class="panel-footer gb-no-padding"> 
      <div class="row">
        ...
        <?php if ($answer->skill->owner_id == Yii::app()->user->id): ?>
