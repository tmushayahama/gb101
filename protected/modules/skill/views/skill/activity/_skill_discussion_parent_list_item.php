 ...
 */
?>
<div class="gb-post-entry gb-discussion-list-item panel panel-default row gb-discussion-title-side-border" skill-discussion-id="<?php echo $skillDiscussionParent->id; ?>"
