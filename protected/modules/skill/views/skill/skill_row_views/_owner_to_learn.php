...
?>
<div class="gb-commitment-post" goal-id="<?php echo $skillListItem->goal_id; ?>">
  <div class="row">
      ...
      <div class="panel-body row">
        ...
        <div class=" col-lg-4 col-sm-12 col-xs-12">
          <ul class="gb-post-action nav nav-stacked">
            ...
            <li class="gb-disabled"><h6><a class="gb-request-monitors-modal-trigger" ><i class="icon icon-eye-open"></i>Get Monitors</a> <a class="badge badge-info pull-right">0</a></h6></li>         
