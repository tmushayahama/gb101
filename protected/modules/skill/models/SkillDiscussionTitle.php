...
class SkillDiscussionTitle extends CActiveRecord {
  ...
  public static function getDiscussionTitles($skillId, $isMentor) {
    $skillDiscussionTitleCriteria = new CDbCriteria;
    $skillDiscussionTitleCriteria->addCondition("skill_id=" . $skillId);
    return SkillDiscussionTitle::model()->findAll($skillDiscussionTitleCriteria);
  }
  ...
  public function rules() {
    ...
    return array(
     ...
     array('discussion_title_id, skill_id, type, privacy, status', 'numerical', 'integerOnly' => true),
     // The following rule is used by search().
     // Please remove those attributes that should not be searched.
     array('id, discussion_title_id, skill_id, type, privacy, status', 'safe', 'on' => 'search'),
    );
  }
