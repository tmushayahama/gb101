...
//These are the types of displays for the post
  ...
  public static function getSkillList($levelCategory = null, $userId = null, $connectionId = null, $levelIds = null, $limit = null) {
...
//$skillListCriteria->addCondition("connection_id=" . $connectionId);
  ...
  public static function getSkillListCount($levelCategory, $levelId, $ownerId) {
    ...
    if ($ownerId) {
      $skillListCriteria->addCondition("user_id=" . $ownerId);
    }
  ...
  public function rules() {
    ...
    return array(
     ...
     array('type_id, user_id, skill_id, level_id, list_bank_parent_id, status, privacy, order', 'numerical', 'integerOnly' => true),
     // The following rule is used by search().
     // Please remove those attributes that should not be searched.
     array('id, type_id, user_id, skill_id, level_id, list_bank_parent_id, status, privacy, order', 'safe', 'on' => 'search'),
    );
  }
