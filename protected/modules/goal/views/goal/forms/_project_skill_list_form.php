...
$form = $this->beginWidget('CActiveForm', array(
 ...
 'htmlOptions' => array(
  ...
  'gb-add-url' => Yii::app()->createUrl("project/project/addProjectSkillList", array("projectId"=>$project->id)),
  'gb-edit-url' => Yii::app()->createUrl("project/project/editProjectSkillList", array()),
