...
<div class="gb-section-row-1 row">
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  <div id="gb-goal-item-todo-panel" class="row">
   <?php
   $this->renderPartial('goal.views.goal.activity.todo._goal_todos_section', array(
     "todoModel" => new Todo(),
...
<div class="gb-section-row-1 row">
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  <div id="gb-goal-item-note-panel" class="row">
   <?php
   $this->renderPartial('goal.views.goal.activity.note._goal_notes_section', array(
     "noteModel" => new Note(),
...
<div class="gb-section-row-1 row">
 <div class="gb-heading row">
  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 gb-padding-none">
   ...
   <div class="gb-subtitle gb-ellipsis">
    <a>
     <?php echo $goalWeblinksCount . " web links"; ?>
    </a>
   </div>
  </div>
  <div class="gb-action col-lg-2 col-md-2 col-sm-2 col-xs-2">
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  <div id="gb-goal-item-weblink-panel" class="row">
   <?php
   $this->renderPartial('goal.views.goal.activity.weblink._goal_weblinks_section', array(
