...
<div class="">
          ...
          <div id="goal-level-selectors" class="row-fluid">
            <?php foreach ($goal_levels as $goal_level): ?>
              <div class="gb-level-selection" value=<?php echo $goal_level->id ?>>
                <?php echo $goal_level->level_name ?>
              </div>
            <?php endforeach ?>
          </div>
        </div>
  ...
  <div class="modal-footer row-fluid">
    <div class="pull-right gb-btn-row-large span6">
      <a id="gb-goal-form-back-btn-disabled" class="span4 gb-btn btn-large gb-btn-disabled-1"><i class="icon-arrow-left"></i> Back</a>
      <a id="gb-goal-form-back-btn" form-num="0" class="span4 gb-btn btn-large gb-btn-border-blue-2"><i class="icon-arrow-left"></i> Back</a>
      <a id="gb-goal-form-next-btn-disabled" class="span4 gb-btn btn-large gb-btn-disabled-1">Next <i class="icon-arrow-right"></i></a>
      <a id="gb-goal-form-next-btn" form-num="0" class="span4 gb-btn btn-large gb-btn-border-blue-2">Next <i class="icon-arrow-right"></i></a>
