  ...
  <div class="gb-post-content">
    ...
    <span class=" span4">
      <ul class="gb-post-action pull-righ nav nav-stacked">
        ...
        <?php else: ?>
          <li><h6><a class="gb-request-menteeship-modal-trigger" goal-id="<?php echo $goalCommitment->id; ?>"><i class="icon icon-eye-open"></i>Mentor</a> <a class="gb-post-action-indicator pull-right">0</a></h6></li>
          <li><h6><a class="gb-request-monitee-modal-trigger" goal-id="<?php echo $goalCommitment->id; ?>"><i class="icon icon-play-circle"></i>Monitor</a> <a class="gb-post-action-indicator pull-right">0</a></h6></li>
