...
<div class="gb-link gb-box-7 row"
     ...
     data-gb-url="<?php echo Yii::app()->createUrl("goal/goal/goal", array('goalId' => $goal->id)); ?>">
 <div class="gb-indicator <?php echo 'gb-level-' . $goal->level->code; ?>"></div>
 <div class="gb-container row">
  <div class="col-lg-2 col-md-2 col-sm-1 col-xs-2 gb-padding-none">
   <img src="<?php echo Yii::app()->request->baseUrl . "/img/profile_pic/" . $goal->creator->profile->avatar_url; ?>" class='pull-right gb-heading-img' alt="">
  </div>
