...
<div class="gb-block gb-section-row-1 row"
 ...
 <div id="gb-goal-form-edit-container" class="row gb-hide gb-panel-form col-lg-12 col-md-12 col-sm-10 col-xs-10">
  <?php
  $this->renderPartial('goal.views.goal.forms._goal_form_edit', array(
    "formId" => "gb-goal-form-edit",
    "actionUrl" => Yii::app()->createUrl("site/goal/editGoal", array()),
    "prependTo" => "",
    "goalModel" => $goal,
 ...
 <div class="row">
  ...
  <div class="row">
   <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
    ...
    <?php endif; ?>
    <?php foreach ($mentorshipGoals as $mentorshipGoal): ?>
     <li class="col-lg-1 col-md-1 col-sm-2 col-xs-3 gb-padding-thinner">
      <img src="<?php echo Yii::app()->request->baseUrl . "/img/profile_pic/" . $mentorshipGoal->creator->profile->avatar_url; ?>" class="gb-heading-img" alt="">
     </li>
    <?php endforeach; ?>
    <?php if ($mentorshipGoalsCount > 6): ?>
     <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gb-padding-thinner">
      <a><?php echo ($mentorshipGoalsCount - 6) . 'more'; ?></a>
     </li>
    <?php endif; ?>
   </ul>
