...
<div class="col-lg-12 col-sm-12 col-xs-12 gb-padding-none gb-no-margin">
 <div class="row">
  ...
  <h5 class="gb-heading-6 col-lg-12 col-sm-12 col-xs-12">
   ...
   <div class="col-lg-1 col-sm-1 col-xs-1 gb-padding-none">
    <i class="pull-right"><?php echo $goalQuestionnairesCount; ?></i>
   </div>
  </h5>
 ...
 <div id="gb-questionnaire-form-container" class="row gb-hide gb-panel-form">
  <div class="row">
   ...
   $this->renderPartial('questionnaire.views.questionnaire.forms._questionnaire_form', array(
     ...
     "actionUrl" => Yii::app()->createUrl("goal/goal/addGoalQuestionnaire", array("goalId" => $goalId)),
     "prependTo" => "#gb-goal-questionnaires",
 ...
 <div id="gb-goal-questionnaires">
  <?php
  $this->renderPartial('goal.views.goal.activity.questionnaire._goal_questionnaires_list', array(
    "goalQuestionnaires" => $goalQuestionnaires,
    "goalQuestionnairesCount" => $goalQuestionnairesCount,
    "goalId" => $goalId,
    "offset" => 1,
  ));
  ?>
