 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <span class="gb-title">Goal Contribution</span>
   </div>
     ...
     <div class="gb-modal-panes-right tab-content col-lg-8 col-md-8 col-sm-8 col-xs-8 col-lg-offset-4 col-md-offset-4 col-sm-offset-4 col-xs-offset-4">
      <div class="tab-pane active" id="tab-r1">
       ...
       <div id="gb-mentorship-form-container" class="row gb-panel-form">
        <?php
        $this->renderPartial('goal.views.goal.forms._mentorship_goal_form', array(
          "formId" => "gb-mentorship-goal-form",
          "actionUrl" => Yii::app()->createUrl("mentorship/mentorship/addMentorship", array("rowType" => null, "goalId" => $goal->id, "requesteeId" => $goal->creator_id)),
