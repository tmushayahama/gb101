    ...
    <li class="active col-lg-12 col-sm-12 col-xs-12 gb-no-padding">
      <a class="row" href="#gb-goal-app-goal-pane" data-toggle="tab">
        <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 gb-no-padding pull-left">
          <img class="gb-icon-2 col-lg-2 gb-no-padding" src="<?php echo Yii::app()->request->baseUrl; ?>/img/goal_icon_2.png" alt="">
          <div class="col-lg-8 gb-no-padding"><p class="gb-ellipsis ">Sub Goals</p></div>
        </div>
    ...
    <li class="col-lg-12 col-sm-12 col-xs-12 gb-no-padding">
      <a class="row" href="#gb-goal-app-mentorship-pane" data-toggle="tab">
        <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 gb-no-padding pull-left">
          ...
          <div class="col-lg-8 gb-no-padding"><p class="gb-ellipsis ">Goals</p></div>
        </div>
        <i class="glyphicon glyphicon-chevron-right pull-right"></i>
      </a>
    </li>
