...
/**
 * This is the model class for table "{{goal_share}}".
 *
 * The followings are the available columns in table '{{goal_share}}':
 * @property integer $id
 ...
 */
class GoalShare extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return GoalShare the static model class
	 */
