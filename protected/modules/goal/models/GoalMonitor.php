...
class GoalMonitor extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('goal_id, monitor_id, level_id', 'required'),
			array('goal_id, monitor_id, level_id, type_id, privacy, status', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, goal_id, monitor_id, level_id, type_id, privacy, status', 'safe', 'on'=>'search'),
		);
	}
