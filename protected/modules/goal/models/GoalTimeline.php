...
class GoalTimeline extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('timeline_id, goal_id, day', 'required'),
			array('timeline_id, goal_id, day, type, privacy, status', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, timeline_id, goal_id, day, type, privacy, status', 'safe', 'on'=>'search'),
		);
	}
