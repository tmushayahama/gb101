...
class GoalController extends Controller {
  ...
  public function actionGoalHome() {
    ...
    $this->render('goal_home', array(
     ...
     'skillList' => GoalList::getGoalList(0, GoalList::$TYPE_SKILL),
     'promiseList' => GoalList::getGoalList(0, GoalList::$TYPE_PROMISE),
     'goalList' => GoalList::getGoalList(0, GoalList::$TYPE_GOAL),
