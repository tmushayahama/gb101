...
<div class="gb-form-header gb-form-header-2">
 <div class="row">
  <h3 class="gb-form-heading pull-left">Add Discussion</h3>
...
<div class="gb-form-body row">
 ...
 <div class="form-group row gb-no-margin">
  <?php echo $form->textArea($discussionModel, 'description', array('id' => 'gb-discussion-form-description-input', 'class' => ' form-control col-lg-12 col-md-12 col-sm-12 col-xs-12', 'maxlength' => 150, 'placeholder' => 'Discussion max 150 characters, just like twitter', 'rows' => '3')); ?>
