...
class DiscussionTitle extends CActiveRecord {
  ...
  public function rules() {
    ...
    return array(
     array('creator_id, goal_id, created_date', 'required'),
     array('creator_id, goal_id', 'numerical', 'integerOnly' => true),
     array('title', 'length', 'max' => 150),
     // The following rule is used by search().
     // Please remove those attributes that should not be searched.
     array('id, title, creator_id, goal_id, created_date', 'safe', 'on' => 'search'),
    );
  }
