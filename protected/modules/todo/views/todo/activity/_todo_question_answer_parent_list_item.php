 ...
 */
?>
<div class="gb-post-entry gb-post-entry-row gb-question-list-item panel panel-default row gb-discussion-title-side-border" todo-question-id="<?php echo $todoquestionParent->id; ?>"
     data-gb-source-pk="<?php echo $todoquestionParent->question_id; ?>" data-gb-source="<?php echo Type::$SOURCE_TODO; ?>">
    ...
    <div class="row gb-padding-left-1">
      <div class="btn-group pull-left">
        <a class="btn btn-sm btn-link gb-form-show"
           ...
           data-gb-target-container="<?php echo '#gb-todo-question-child-form-container-' . $todoquestionParent->id; ?>"
