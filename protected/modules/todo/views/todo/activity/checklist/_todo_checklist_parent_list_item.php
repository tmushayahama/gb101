 ...
 */
?>
<div class="gb-block gb-block-row gb-checklist-row gb-background-white row gb-padding-thin" todo-checklist-id="<?php echo $todoChecklistParent->id; ?>"
     data-gb-source-pk="<?php echo $todoChecklistParent->checklist_id; ?>" data-gb-source="<?php echo Type::$SOURCE_TODO; ?>">

  <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 gb-padding-none text-center">
  ...
  <div class="col-lg-10 col-sm-10 col-xs-9 gb-padding-none gb-no-margin">
    ...
    <div class="row gb-panel-display">
      <a class="gb-modal-trigger gb-display-attribute gb-ellipsis col-lg-12 col-md-12 col-sm-12 col-xs-12 gb-padding-none" 
