 ...
 */
?>
<div class="gb-post-entry gb-post-entry-row gb-parent-box row" todo-question-id="<?php echo $todoquestionParent->id; ?>"
    ...
    <div class="row gb-padding-left-1">
      <div class="btn-group pull-left gb-disabled-1">
        <a class="btn btn-sm btn-link gb-form-show"
           ...
           data-gb-target-container="<?php echo '#gb-todo-questionnaire-child-form-container-' . $todoquestionParent->id; ?>"
