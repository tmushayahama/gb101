...
<div class="row gb-block gb-block-row gb-block-row-sm"
 ...
 <div class="gb-row-bullet col-lg-1 col-md-1 col-sm-1">
  <h5 class="gb-number"><?php echo $todoChildCounter; ?></h5>
 </div>
 <div class="col-lg-11 col-md-11 col-sm-11 gb-padding-none">
  <div class="row gb-row-display ">
   <div class="col-lg-1 col-md-1 col-sm-1 gb-padding-none">
    <img src="<?php echo Yii::app()->request->baseUrl . "/img/profile_pic/" . $todoChild->creator->profile->avatar_url; ?>" class="gb-heading-img img-circle pull-right" alt="">
   </div>
   <div class="col-lg-11 col-sm-11 col-xs-12 gb-padding-none gb-no-margin">
    <div class="row">
     <h5 class="gb-heading">
      <span>
       <a href="<?php echo Yii::app()->createUrl('user/profile/profile/', array('user' => $todoChild->creator_id)); ?>">
        <?php echo $todoChild->creator->profile->firstname . " " . $todoChild->creator->profile->lastname ?>
       </a>
      </span>
      <span><i class="gb-small-text"><?php echo date_format(date_create($todoChild->created_date), 'M jS \a\t g:ia'); ?></i></span>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gb-padding-none">
       <p>
        <span class="gb-display-attribute" data-gb-control-target="#gb-todo-form-description-input">
         <?php echo $todoChild->description; ?></span>
       </p>
      </div>
     </div>
    </div>
