...
<div class="gb-block gb-block-row gb-bottom-border-grey-1 gb-weblink-list-item row gb-padding-left-3" todo-weblink-id="<?php echo $todoWeblinkChild->id; ?>"
     data-gb-source-pk="<?php echo $todoWeblinkChild->weblink_id; ?>" data-gb-source="<?php echo Type::$SOURCE_TODO; ?>">

  <div class="col-lg-12 col-sm-12 col-xs-12 gb-padding-none gb-margin">
    ...
    <div class="gb-hide gb-padding-none gb-show-more">
