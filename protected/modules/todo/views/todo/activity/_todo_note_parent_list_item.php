 ...
 */
?>
<div class="gb-post-entry gb-post-entry-row gb-note-list-item panel panel-default row gb-discussion-title-side-border" todo-note-id="<?php echo $todoNoteParent->id; ?>"
    ...
    <div class="row gb-padding-left-1">
      <div class="btn-group pull-left">
        <a class="btn btn-sm btn-link gb-form-show"
           gb-is-child-form="1"
           data-gb-target-container="<?php echo '#gb-todo-note-child-form-container-' . $todoNoteParent->id; ?>"
