...
<div class="gb-todo-item row" gb-source="<?php echo Type::$SOURCE_TODO; ?>"
  ...
  <div class="row gb-stat-box">
    <div class="gb-heading col-lg-12 col-md-12 col-sm-12 col-xs-12  ">
      <div class="gb-title text-center">
        <h4>Todo Progress</h4>
        <div class="progress gb-progress-bar">
          <div class="gb-checklist-item-progress progress-bar progress-bar-info col-lg-12 col-sm-12 col-xs-12 " 
               role="progressbar" 
