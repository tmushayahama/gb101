...
?>
<div class="gb-skill-gained gb-discussion-title-side-border" skill-id="<?php echo $skillListItem->skill_id; ?>">
  <div class="row">
    ...
    <div class="panel panel-default gb-no-padding gb-skill-gained-top-border col-lg-10 col-sm-10 col-xs-12">
      <div class="panel-heading">
        <h5><a href="<?php echo $skillUrl; ?>"><?php echo $skillListItem->level->name ?></a> - <a href="<?php echo Yii::app()->createUrl('user/profile/profile/', array('user' => $skillListItem->owner_id)); ?>"><?php echo $skillListItem->owner->profile->firstname . " " . $skillListItem->owner->profile->lastname ?></a></h5>
      </div> 
