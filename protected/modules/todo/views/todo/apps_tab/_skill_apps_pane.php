    ...
    <li class="active col-lg-12 col-sm-12 col-xs-12 ">
      <a class="row" href="#gb-todo-app-todo-pane" data-toggle="tab">
        <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11  pull-left">
          <img class="gb-icon-2 col-lg-2 " src="<?php echo Yii::app()->request->baseUrl; ?>/img/todo_icon_2.png" alt="">
          <div class="col-lg-8 "><p class="gb-ellipsis ">Sub Todos</p></div>
        </div>
    ...
    <li class="col-lg-12 col-sm-12 col-xs-12 ">
      <a class="row" href="#gb-todo-app-mentorship-pane" data-toggle="tab">
        <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11  pull-left">
          ...
          <div class="col-lg-8 "><p class="gb-ellipsis ">Todos</p></div>
        </div>
        <i class="glyphicon glyphicon-chevron-right pull-right"></i>
      </a>
    </li>
