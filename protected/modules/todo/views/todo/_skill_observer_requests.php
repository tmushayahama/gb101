...
<div class="gb-post-entry-row row" data-gb-source-pk="0" todo-list-id="<?php echo $todoListItem->id; ?>"
    ...
    <div class="gb-post-entry-row col-lg-6 col-md-6 col-sm-6 col-xs-12 gb-padding-thin" data-gb-source-pk="<?php echo $todoObserverRequest->id; ?>" data-gb-source="<?php echo Type::$SOURCE_NOTIFICATION; ?>">
