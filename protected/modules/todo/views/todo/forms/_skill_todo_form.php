...
$form = $this->beginWidget('UActiveForm', array(
 ...
 'htmlOptions' => array(
  ...
  'gb-add-url' => Yii::app()->createUrl("todo/todo/addTodoTodo", array("todoId" => $todoId)),
...
<div class="gb-form-body row">
  ...
  <div class="form-group row gb-hide">
    <?php echo $form->hiddenField($todoModel, 'parent_todo_id', array('id' => 'gb-todo-todo-form-parent-todo-id-input')); ?>
  </div>
