 ...
 */
?>
<div id="gb-advice-contribute-request-modal"  gb-type="<?php //echo $modalType   ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="gb-form-body row">
        <div class="list-group">
          <a class="list-group-item active gb-select-sharing-type" gb-type="<?php echo Type::$SHARE_PUBLIC; ?>" >
            <h4 class="list-group-item-heading">Advice Observer</h4>
            <p class="list-group-item-text">Observes the advice progress and activities.</p>
          </a>
          <a class="list-group-item gb-select-sharing-type" gb-type="<?php echo Type::$SHARE_PRIVATE; ?>">
            <h4 class="list-group-item-heading">Advice Contributor</h4>
            <p class="list-group-item-text">Contributors the level of advice, progress, ratings etc.</p>
          </a>
        </div>
