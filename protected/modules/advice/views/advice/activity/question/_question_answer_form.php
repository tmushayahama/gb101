...
<div class="row gb-padding-thin">
 ...
 <div class="form-group gb-hide row">
  <?php echo $form->hiddenField($adviceQuestionAnswerModel, 'question_id', array('value' => $questionId)); ?>
 </div>
 <div class="row">
  <div class="form-group col-lg-10 col-md-10 col-sm-12 col-xs-12">
   <?php echo $form->textArea($adviceQuestionAnswerModel, 'description', array('id' => 'gb-user-question-form-description-input', 'class' => ' form-control col-lg-12 col-md-12 col-sm-12 col-xs-12', 'maxlength' => 150, 'placeholder' => 'Answer', 'rows' => '2')); ?>
   <?php echo $form->error($adviceQuestionAnswerModel, 'description') ?>
  </div>
