...
$form = $this->beginWidget('CActiveForm', array(
  ...
  'htmlOptions' => array(
    ...
    "data-gb-source-pk" => $contributorModel->id,
    "data-gb-source" => Type::$SOURCE_CONTRIBUTOR,
...
<div class="input-group form-group col-lg-12 col-sm-12 col-xs-12 gb-no-padding gb-no-margin">
 ...
 <?php echo $form->textArea($contributorModel, 'description', array('class' => 'form-control', 'maxlength' => 150, 'placeholder' => 'Your reply', 'rows' => '2')); ?>
