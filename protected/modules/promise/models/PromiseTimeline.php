...
class PromiseTimeline extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('timeline_id, promise_id, day', 'required'),
			array('timeline_id, promise_id, day, type, privacy, status', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, timeline_id, promise_id, day, type, privacy, status', 'safe', 'on'=>'search'),
		);
	}
