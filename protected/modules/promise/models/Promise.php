...
//These are the types of displays for the post
 ...
 public static function getPromises($levelId = null, $limit = null, $offset = null) {
 ...
 public static function getPromisesCount($levelId = null, $offset = null) {
  $promiseCriteria = new CDbCriteria;
  if ($levelId) {
   $promiseCriteria->addCondition("level_id=" . $levelId);
  }
...
//$promiseCriteria->addCondition("connection_id=" . $connectionId);
 ...
 public function rules() {
  ...
  return array(
    ...
    array('parent_promise_id, creator_id, type_id, level_id, bank_id, privacy, order, status', 'numerical', 'integerOnly' => true),
    array('title', 'length', 'max' => 100),
    array('description', 'length', 'max' => 500),
    array('created_date', 'safe'),
    // The following rule is used by search().
    // Please remove those attributes that should not be searched.
    array('id, parent_promise_id, creator_id, type_id, title, description, created_date, level_id, bank_id, privacy, order, status', 'safe', 'on' => 'search'),
  );
 }
 ...
 public function relations() {
  ...
  return array(
    ...
    'goals' => array(self::HAS_MANY, 'Goal', 'promise_id'),
    'hobbies' => array(self::HAS_MANY, 'Hobby', 'promise_id'),
    'journals' => array(self::HAS_MANY, 'Journal', 'promise_id'),
    'mentorships' => array(self::HAS_MANY, 'Mentorship', 'promise_id'),
    ...
    'promises' => array(self::HAS_MANY, 'Promise', 'promise_id'),
    ...
    'type' => array(self::BELONGS_TO, 'PromiseType', 'type_id'),
