...
//$promiseCriteria->addCondition("connection_id=" . $connectionId);
 ...
 public function rules() {
  ...
  return array(
    ...
    array('parent_promise_id, creator_id, level_id, points, privacy, order, status', 'numerical', 'integerOnly' => true),
    ...
    array('id, parent_promise_id, creator_id, promise_picture_url, title, description, created_date, level_id, points, privacy, order, status', 'safe', 'on' => 'search'),
  );
 }
