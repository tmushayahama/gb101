...
class PromiseContributor extends CActiveRecord {
 ...
 public function rules() {
  ...
  return array(
    array('contributor_id, promise_id', 'required'),
    array('contributor_id, promise_id, privacy, status', 'numerical', 'integerOnly' => true),
    // The following rule is used by search().
    // Please remove those attributes that should not be searched.
    array('id, contributor_id, promise_id, privacy, status', 'safe', 'on' => 'search'),
  );
 }
