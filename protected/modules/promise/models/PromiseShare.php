...
/**
 * This is the model class for table "{{promise_share}}".
 *
 * The followings are the available columns in table '{{promise_share}}':
 * @property integer $id
 ...
 */
class PromiseShare extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PromiseShare the static model class
	 */
