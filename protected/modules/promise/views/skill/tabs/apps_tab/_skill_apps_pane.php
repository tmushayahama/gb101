    ...
    <li class="active col-lg-12 col-sm-12 col-xs-12 gb-padding-none">
      <a class="row" href="#gb-skill-app-skill-pane" data-toggle="tab">
        <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 gb-padding-none pull-left">
          <img class="gb-icon-2 col-lg-2 gb-padding-none" src="<?php echo Yii::app()->request->baseUrl; ?>/img/skill_icon_2.png" alt="">
          <div class="col-lg-8 gb-padding-none"><p class="gb-ellipsis ">Sub Skills</p></div>
        </div>
