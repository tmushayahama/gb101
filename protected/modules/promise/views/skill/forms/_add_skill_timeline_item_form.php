...
$form = $this->beginWidget('UActiveForm', array(
  ...
  'htmlOptions' => array(
    ...
    'data-gb-url' => Yii::app()->createUrl("skill/skill/addSkillTimeline", array("skillId" => $skillId)),
...
<div class="form-group row">
 <?php echo $form->textField($skillTimelineModel, 'day', array('id' => 'gb-skill-timeline-form-day-input', 'class' => ' form-control col-lg-12 col-sm-12 col-md-12 col-xs-12', 'maxlength' => 4, 'placeholder' => 'Step')); ?>
