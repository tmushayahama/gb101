...
?>
<div class="gb-post-entry gb-post-entry-row gb-promise-gained" promise-id="<?php echo $promiseListItem->id; ?>" 
     data-gb-source-pk="<?php echo $promiseListItem->id; ?>" data-gb-source="<?php echo Type::$SOURCE_SKILL; ?>">
  <div class="row">
      ...
      <div class="panel-footer gb-panel-display gb-no-padding">
        <div class="row">
          <div class="pull-right">
            <a class="btn btn-link gb-edit-form-show" data-gb-target="#gb-promise-list-form"><i class="glyphicon glyphicon-edit"></i></a>
