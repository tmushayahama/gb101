 ...
 */
?>
<div class="row gb-post-entry gb-post-entry-row gb-post-entry-row-lg" promise-question-id="<?php echo $promiseQuestionParent->id; ?>"
 ...
 <div class="col-lg-11 col-md-11 col-sm-11 gb-no-padding">
  <div class="row gb-row-display ">
   <div class="col-lg-1 col-md-1 col-sm-1 gb-no-padding">
    <img src="<?php echo Yii::app()->request->baseUrl . "/img/profile_pic/" . $promiseQuestionParent->question->creator->profile->avatar_url; ?>" class="gb-heading-img img-circle pull-right" alt="">
   </div>
   <div class="col-lg-11 col-sm-11 col-xs-12 gb-no-padding gb-no-margin">
    <div class="row">
     ...
     <h5 class="gb-heading">
      <span>
       <a href="<?php echo Yii::app()->createUrl('user/profile/profile/', array('user' => $promiseQuestionParent->question->creator_id)); ?>">
        <?php echo $promiseQuestionParent->question->creator->profile->firstname . " " . $promiseQuestionParent->question->creator->profile->lastname ?>
       </a>
      </span>
      <span><i class="gb-small-text"><?php echo date_format(date_create($promiseQuestionParent->question->created_date), 'M jS \a\t g:ia'); ?></i></span>
    ...
    <div>
     ...
     <?php foreach ($promiseQuestionChildren as $promiseQuestionChild): ?>
         <?php
         $this->renderPartial('promise.views.promise.activity._promise_question_child_list_item', array(
