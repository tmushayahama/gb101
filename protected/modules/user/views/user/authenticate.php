...
<header>
 <div class="container">
  <div class="intro-text">
   <div class="intro-lead-in">Tools and Apps you need to use your skills.</div>
   <div class="intro-heading">Apply & Explore your Skills</div>
 ...
 <div class="container">
  <div class="row gb-hide">
   <div class="col-lg-12 text-center">
    <h2 class="section-heading">Start Today</h2>
  ...
  <div class="row text-center">
   <div class="col-md-4">
    ...
    <h4 class="service-heading">Explore</h4>
    <p class="text-muted">using the skill bank</p>
   </div>
   <div class="col-md-4">
    <span class="fa-stack fa-4x">
     <i class="fa fa-circle fa-stack-2x text-primary"></i>
    ...
    <p class="text-muted">from the community</p>
   </div>
   <div class="col-md-4">
    <span class="fa-stack fa-4x">
     <i class="fa fa-circle fa-stack-2x text-primary"></i>
    ...
    <p class="text-muted">using our applications</p>
   </div>
  </div>
 </div>
</section>
...
<section id="portfolio" class="bg-light-gray gb-hide">
 <div class="container">
  <div class="row">
   <div class="col-lg-12 text-center">
    <h2 class="section-heading">Skill Applications</h2>
    <h3 class="section-subheading text-muted">Make use of our Applications.</h3>
   </div>
  </div>
  <div class="row">
...
<!-- About Section -->
<section id="about" class="gb-hide">
 <div class="container">
  <div class="row">
   <div class="col-lg-12 text-center">
...
<!-- Team Section -->
<section id="team" class="bg-light-gray gb-hide">
 <div class="container">
  <div class="row">
   <div class="col-lg-12 text-center">
...
<div class="gb-hide">
 ...
 <div class="gb-intro-header-4 row">
  <div class="container">
   ...
   <div class="pull-right col-lg-8 col-sm-12 col-xs-12 ">
