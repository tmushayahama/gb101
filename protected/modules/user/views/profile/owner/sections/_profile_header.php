...
<div class="gb-block gb-profile-header-1 row"
 ...
 <div class="gb-panel-display col-lg-8 col-md-8 col-sm-7 col-xs-10">
 ...
 <div id="gb-profile-welcome-form-container" class="row gb-hide gb-panel-form col-lg-10 col-md-10 col-sm-10 col-xs-10">
  <?php
 ...
 <div class="gb-panel-display col-lg-2 col-md-2 col-sm-3 col-xs-12 gb-padding-medium">
  <div class="row">
   <div class="btn btn-default gb-edit-form-show gb-backdrop-disappear col-lg-12 col-md-12 col-sm-12 col-xs-6 gb-padding-medium">
    <i class="glyphicon glyphicon-edit"></i> Edit
   </div>
   <br>
   <br>
   <div class="gb-disabled-1 btn btn-primary col-lg-12 col-md-12 col-sm-12 col-xs-6 gb-padding-medium">
