    ...
    <div class="gb-top-heading row">
      <div class="row">
        <ul id="" class="row gb-nav-1">
          <li class="active col-lg-6 col-md-6 col-sm-12 col-xs-12 "><a href="#project-management-welcome-pane" data-toggle="tab"><p class="col-lg-12 col-md-12 col-sm-12 col-xs-12  pull-left gb-ellipsis"><?php echo $profile->firstname . " " . $profile->lastname; ?></p></a></li>
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="project-management-welcome-pane">
        <div class="gb-home-left-nav col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
          <ul id="" class="gb-side-nav-1 col-lg-12 col-md-12 col-sm-12 col-xs-12 gb-nav-for-background-7 row ">
      ...
      <div class="tab-pane" id="project-management-apps-pane">
        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 ">
          <ul class="gb-side-nav-1 gb-nav-for-background-7 row ">
            <li class="active col-lg-12 col-sm-12 col-xs-12 ">
              <a class="row" href="#gb-project-app-skill-pane" data-toggle="tab">
                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11  pull-left">
                  <img class="gb-icon-2 col-lg-2 " src="<?php echo Yii::app()->request->baseUrl; ?>/img/skill_icon_7.png" alt="">
                  <div class="col-lg-8 "><p class="gb-ellipsis ">Skills</p></div>
                </div>
                <i class="glyphicon glyphicon-chevron-right pull-right"></i>
              </a>
            </li>
            <li class="col-lg-12 col-sm-12 col-xs-12 ">
              <a class="row" href="#gb-project-app-mentorship-pane" data-toggle="tab">
                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11  pull-left">
                  <img class="gb-icon-2 col-lg-2 " src="<?php echo Yii::app()->request->baseUrl; ?>/img/mentorship_icon_7.png" alt="">
                  <div class="col-lg-8 "><p class="gb-ellipsis ">Mentorships</p></div>
                </div>
                <i class="glyphicon glyphicon-chevron-right pull-right"></i>
              </a>
            </li>
            <li class="col-lg-12 col-sm-12 col-xs-12 ">
              <a class="row" href="#gb-project-app-advice-pages-pane" data-toggle="tab">
                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11  pull-left">
                  <img class="gb-icon-2 col-lg-2 " src="<?php echo Yii::app()->request->baseUrl; ?>/img/advice_pages_icon_7.png" alt="">
