...
<div class="container-fluid">
  <div id="profile-main-container">
    <div class="row-fluid">
      ...
      <div id="gb-profile-header" class="">
        <img class="img-polaroid"href="/profile" src="<?php echo Yii::app()->request->baseUrl; ?>/img/gb_avatar.jpg" alt="">
        <div class="user-info-container span9">
          <ul class="nav nav-stacked user-info span5">
            <h2 class="name">Tremayne Mushayahama</h2>
          ...
          <ul class="nav nav-stacked activities-summary span3">
            <li>
              <a class="">
