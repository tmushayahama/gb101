...
<div class="gb-form-header gb-form-header-2">
 <div class="row">
  <h3 class="gb-form-heading pull-left">Add Questionnaire</h3>
...
<div class="gb-form-body row">
 ...
 <div class="form-group row gb-no-margin">
  <?php echo $form->textArea($questionnaireModel, 'description', array('id' => 'gb-questionnaire-form-description-input', 'class' => ' form-control col-lg-12 col-md-12 col-sm-12 col-xs-12', 'maxlength' => 150, 'placeholder' => 'Questionnaire max 150 characters, just like twitter', 'rows' => '3')); ?>
