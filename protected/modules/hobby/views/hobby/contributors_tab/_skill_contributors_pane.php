        ...
        <li class="col-lg-12 col-sm-12 col-xs-12 gb-no-padding">
          <a class="row" href="#gb-contributor-person-pane" data-toggle="tab"
            ...
            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 gb-no-padding pull-left">
              <img class="gb-icon-2 col-lg-2 gb-no-padding" src="<?php echo Yii::app()->request->baseUrl . "/img/profile_pic/" . $hobbyContributor->contributor->profile->avatar_url; ?>" alt="">
              <div class="col-lg-9 gb-no-padding"><p class="gb-ellipsis "><?php echo $hobbyContributor->contributor->profile->firstname . " " . $hobbyContributor->contributor->profile->lastname; ?></p></div>
            </div>
            <i class="glyphicon glyphicon-chevron-right pull-right"></i>
          </a>
        </li>
      ...
      <?php foreach ($hobbyObservers as $hobbyObserver): ?>
        <li class="col-lg-12 col-sm-12 col-xs-12 gb-no-padding">
          <a class="row" href="#gb-contributor-person-pane" data-toggle="tab"
            ...
            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 gb-no-padding pull-left">
              <img class="gb-icon-2 col-lg-2 gb-no-padding" src="<?php echo Yii::app()->request->baseUrl . "/img/profile_pic/" . $hobbyObserver->observer->profile->avatar_url; ?>" alt="">
              <div class="col-lg-9 gb-no-padding"><p class="gb-ellipsis "><?php echo $hobbyObserver->observer->profile->firstname . " " . $hobbyObserver->observer->profile->lastname; ?></p></div>
            </div>
            <i class="glyphicon glyphicon-chevron-right pull-right"></i>
          </a>
        </li>
