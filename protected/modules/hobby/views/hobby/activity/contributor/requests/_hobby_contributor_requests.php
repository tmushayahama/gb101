...
if ($requestsCount == 0):
 ...
 <h5 class="text-center text-warning gb-no-information row">
  no pending hobby judge requests
 </h5>
<?php endif; ?>
...
foreach ($requests as $request):
 ?>
 <?php
 $this->renderPartial('hobby.views.hobby.activity.contributor.requests._hobby_contributor_request', array(
   "request" => $request,
