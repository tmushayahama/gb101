...
<div class="form-group row">
 <?php echo $form->textField($hobbyTimelineModel, 'day', array('id' => 'gb-hobby-timeline-form-day-input', 'class' => ' form-control col-lg-12 col-sm-12 col-md-12 col-xs-12', 'maxlength' => 4, 'placeholder' => 'Step')); ?>
