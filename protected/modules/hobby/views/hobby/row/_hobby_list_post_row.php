...
?>
<div class="gb-post-entry gb-post-entry-row gb-hobby-gained" hobby-id="<?php echo $hobbyListItem->id; ?>" 
     data-gb-source-pk="<?php echo $hobbyListItem->id; ?>" data-gb-source="<?php echo Type::$SOURCE_SKILL; ?>">
  <div class="row">
