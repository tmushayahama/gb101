 ...
 */
?>
<div id="gb-hobby-play-modal" class="modal gb-modal-lg fade gb-z-index-2000" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    <button type="button" class="btn btn-default pull-right" data-dismiss="modal" aria-hidden="true">X</button>
    <span class="gb-title">Hobby Play</span>
   </div>
     ...
     <div class="gb-modal-panes-right tab-content col-lg-8 col-md-8 col-sm-8 col-xs-8 col-lg-offset-4 col-md-offset-4 col-sm-offset-4 col-xs-offset-4">
      <div class="tab-pane active" id="tab-r1">
       ...
       <div class="gb-panel-display row">
        <div class="row">
         <?php
         $this->renderPartial('hobby.views.hobby.forms._hobby_play_form', array(
      ...
      <div class="tab-pane" id="tab-r3">
       <p>
        Stay tuned! Hobbys are coming soon
       </p>
      </div>
