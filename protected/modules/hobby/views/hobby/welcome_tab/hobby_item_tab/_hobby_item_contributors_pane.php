...
<div class="col-lg-12 col-sm-12 col-xs-12 gb-padding-none gb-no-margin">
 <div class="row">
  ...
  <h5 class="gb-heading-6 col-lg-12 col-sm-12 col-xs-12">
   <div class="col-lg-11 col-sm-11 col-xs-11 gb-padding-thin">
    <p class="gb-ellipsis">Contributors (<i><?php echo $hobbyContributorsCount; ?></i>)
    </p>
   </div>
 ...
 <div id="gb-hobby-contributors">
  <?php
  $this->renderPartial('hobby.views.hobby.activity.contributor._hobby_contributors', array(
