...
<div class="row gb-box-7">
 ...
 <div id="gb-comment-form-container" class="row gb-hide gb-panel-form">
  <div class="row">
   ...
   $this->renderPartial('comment.views.comment.forms._comment_form', array(
     ...
     "actionUrl" => Yii::app()->createUrl("hobby/hobby/addHobbyComment", array("hobbyId" => $hobby->id)),
     "prependTo" => "#gb-hobby-comments-overview",
 ...
 <div id="gb-hobby-comments-overview">
  <?php
