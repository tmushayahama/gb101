...
<div class="container">
  <div class="tab-content gb-background-light-grey-1">
    <div class="tab-pane active" id="skill-mentorship-mentorships-pane">
      <div class="gb-home-left-nav col-lg-4 col-md-4 col-sm-12 col-xs-12 gb-padding-none">
        <br>
        <?php
      ...
      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 gb-padding-none ">
        <div class="panel panel-default gb-side-margin-thick gb-padding-none gb-background-light-grey-1">
          ...
          <div class="tab-content gb-padding-none">
            <br>
    ...
    <div class="tab-pane" id="skill-mentorship-reports-pane">
      <div class="gb-home-left-nav col-lg-4 col-md-4 col-sm-4 col-xs-12 gb-padding-none">
        <br>
      ...
      <div class="tab-content col-lg-8 col-md-8 col-sm-8 col-xs-12 gb-background-light-grey-1 gb-padding-none">
        <br>
