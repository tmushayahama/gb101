  ...
  <div class="gb-top-heading row">
    ...
    <div class="row">
      <ul id="" class="row gb-nav-1">
        <li class="active col-lg-6 col-md-6 col-sm-12 col-xs-12 "><a href="#project-management-welcome-pane" data-toggle="tab"><p class="col-lg-12 col-md-12 col-sm-12 col-xs-12  pull-left gb-ellipsis"><?php echo $project->name; ?></p></a></li>
