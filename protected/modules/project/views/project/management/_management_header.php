<div class="container">
  <div class="gb-top-heading row">
    <h2 class="gb-ellipsis">Project Management</h2>
    <div class="row">
      <ul id="" class="row gb-nav-1">
        <li class="active col-lg-6 col-md-6 col-sm-12 col-xs-12 gb-padding-none"><a href="#project-management-welcome-pane" data-toggle="tab"><p class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gb-padding-none pull-left gb-ellipsis"><?php echo $project->name; ?></p></a></li>
