  ...
  <div class="gb-top-heading row">
    ...
    <div class="row">
      <ul id="" class="col-lg-12 col-sm-12 col-xs-12 gb-nav-1">
        ...
        <li class="col-lg-3 col-md-2 col-sm-6 col-xs-6"><a href="#project-management-apps-pane" data-toggle="tab"><p class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left gb-ellipsis">Project Apps</p></a></li>
