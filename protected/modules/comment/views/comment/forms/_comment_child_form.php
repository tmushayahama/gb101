...
<div class="form-group gb-hide row">
 <?php echo $form->hiddenField($commentModel, 'parent_comment_id', array("value" => $parentValue)); ?>
</div>
<div class="input-group form-group col-lg-12 col-sm-12 col-xs-12  gb-no-margin">

 <?php echo $form->textArea($commentModel, 'description', array('class' => 'form-control', 'maxlength' => 150, 'placeholder' => 'Your reply', 'rows' => '1')); ?>
