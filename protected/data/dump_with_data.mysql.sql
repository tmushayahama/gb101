...
--
-- Table structure for table `gb_advice_page_subskill`
--
...
--
-- Dumping data for table `gb_advice_page_subskill`
--

LOCK TABLES `gb_advice_page_subskill` WRITE;
/*!40000 ALTER TABLE `gb_advice_page_subskill` DISABLE KEYS */;
INSERT INTO `gb_advice_page_subskill` VALUES (1,1,10),(2,1,11),(3,1,12),(4,1,13),(5,1,14);
/*!40000 ALTER TABLE `gb_advice_page_subskill` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `gb_skill_list`
--

LOCK TABLES `gb_skill_list` WRITE;
/*!40000 ALTER TABLE `gb_skill_list` DISABLE KEYS */;
INSERT INTO `gb_skill_list` VALUES (1,1,2,1,2,NULL,1,1,1),(2,1,2,2,1,NULL,1,1,1),(3,1,2,3,2,NULL,1,2,1),(4,1,2,4,3,NULL,1,1,1),(5,1,2,5,1,NULL,1,1,1),(6,1,2,6,5,NULL,1,0,1),(7,1,2,7,5,NULL,1,0,1),(8,1,2,8,5,NULL,1,0,1),(9,1,2,9,5,NULL,1,0,1),(10,1,2,10,5,NULL,1,0,1),(11,1,2,11,5,NULL,1,0,1),(12,1,2,12,5,NULL,1,0,1),(13,1,2,13,5,NULL,1,0,1),(14,1,2,14,5,NULL,1,0,1);
/*!40000 ALTER TABLE `gb_skill_list` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `gb_skill_list_share`
--

LOCK TABLES `gb_skill_list_share` WRITE;
/*!40000 ALTER TABLE `gb_skill_list_share` DISABLE KEYS */;
INSERT INTO `gb_skill_list_share` VALUES (1,3,6,1),(2,3,7,1),(3,3,3,1);
/*!40000 ALTER TABLE `gb_skill_list_share` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `gb_subskill`
--

LOCK TABLES `gb_subskill` WRITE;
/*!40000 ALTER TABLE `gb_subskill` DISABLE KEYS */;
/*!40000 ALTER TABLE `gb_subskill` ENABLE KEYS */;
UNLOCK TABLES;
