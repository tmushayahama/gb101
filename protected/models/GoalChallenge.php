...
class GoalChallenge extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('assigner_id, challenger_id, goal_id', 'required'),
			array('assigner_id, challenger_id, goal_id, connection_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, assigner_id, challenger_id, goal_id, connection_id', 'safe', 'on'=>'search'),
		);
	}
