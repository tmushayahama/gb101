...
//$goalListCriteria->addCondition("connection_id=" . $connectionId);
	...
	public function rules()
	{
		...
		return array(
			array('type_id, user_id, goal_id, goal_level_id', 'required'),
			array('type_id, user_id, goal_id, goal_level_id, list_bank_parent_id, status, order', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, type_id, user_id, goal_id, goal_level_id, list_bank_parent_id, status, order', 'safe', 'on'=>'search'),
		);
	}
