  ...
  <body>
    ...
    <div id="gb-navbar" class="navbar navbar-static-top">  
              ...
              <div class="tab-content gb-padding-left-3 gb-height-7 gb-scrollable">
                <div class="tab-pane active" id="gb-second-generation-apps-pane">
                  ...
                  <div class="row gb-home-nav">
                    ...
                    <a href="<?php echo Yii::app()->createUrl("pages/pages/pageshome", array()); ?>" class="col-lg-3 col-md-3 col-sm-4 col-xs-4 gb-no-padding" data-toggle="dropdown">
                      <div class="thumbnail">
                ...
                <div class="tab-pane" id="gb-third-generation-apps-pane">
                  ...
                  <div class="row gb-home-nav">
                    <a href="<?php echo Yii::app()->createUrl("project/project/projecthome"); ?>" class="col-lg-2 col-md-2 col-sm-3 col-xs-4 gb-no-padding">
                      <div class="thumbnail">
                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/img/project_icon_0.png" alt="">
                        <div class="caption">
      ...
      <div id="gb-notifications-dropdown" class="container-fluid gb-mega-dropdown gb-hide gb-background-light-grey-1">
        <br>
        <div class="container gb-scrollable">
