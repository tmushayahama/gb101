      ...
      <div class="box">
        ...
        <div class="row row-offcanvas row-offcanvas-left">
          ...
          <div class="column col-sm-2 col-xs-1 sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav hidden-sm hidden-xs" id="lg-menu">
              <li><a class="" href="<?php echo Yii::app()->createUrl("user/login"); ?>"><i class="glyphicon glyphicon-home"></i> Guest Home</a></li>
            ...
            <!-- tiny only nav-->
            <ul class="nav visible-sm visible-xs" id="xs-menu">
