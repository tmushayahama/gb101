   ...
   <div class="container">
    <div class="row">
     ...
     <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 ">
      <ul id="gb-nav-collapse" class="collapse navbar-collapse nav ">
       <li class="row">
        <div id="gb-navbar-nav" class="row col-lg-9 col-md-9 col-sm-9 col-xs-12">
         <a href="<?php echo Yii::app()->createUrl("user/login"); ?>" class="col-lg-3 col-md-3 col-sm-2 col-xs-4 ">
          <div class="thumbnail">
         ...
         <a href="<?php echo Yii::app()->createUrl("skill/skill/skillbank", array()); ?>" class="col-lg-2 col-md-2 col-sm-2 col-xs-4 ">
          <div class="thumbnail">
         ...
         <a href="<?php echo Yii::app()->createUrl("mentorship/mentorship/mentorshiphome", array()); ?>" class="col-lg-2 col-md-2 col-sm-2 col-xs-4 ">
          <div class="thumbnail">
         ...
         <a href="<?php echo Yii::app()->createUrl("pages/pages/pageshome", array()); ?>" class="col-lg-2 col-md-2 col-sm-2 col-xs-4 ">
          <div class="thumbnail">
         ...
         <a href="<?php echo Yii::app()->createUrl("people/", array()); ?>" class="col-lg-2 col-md-2 col-sm-2 col-xs-4 ">
          <div class="thumbnail">
         ...
         <a class="gb-disabled col-lg-1 col-md-1 col-sm-2 col-xs-4 ">
          <div class="thumbnail">
