...
<div class="gb-add-person-badge">
  ...
  <button class="pull-right action add-connection-member-btn gb-btn gb-btn-grey-1" user-id="<?php echo $nonConnectionMember->user_id ?>"><i class="glyphicon glyphicon-plus-sign"></i> Add</button>
