...
<div class="gb-request-notification-row panel panel-default">
 ...
 <div class="col-lg-10 col-sm-10 col-xs-10 panel panel-default gb-no-padding gb-discussion-title-side-border">
  <div class="panel-body">
   <?php $requestText = ""; ?>
   <?php
   if ($request->type_id == Type::$SOURCE_MENTEE_REQUESTS ||
     $request->type_id == Type::$SOURCE_MENTEE_REQUESTS) :
    ?>
    <?php $requestText = "Mentee Request"; ?>
    <?php
   elseif ($request->type_id == Type::$SOURCE_MENTOR_REQUESTS ||
     $request->type_id == Type::$SOURCE_MENTOR_REQUESTS) :
    ?>
    <?php $requestText = "Mentor Request"; ?>
    <?php
   elseif ($request->type_id == Notification::$NOTIFICATION_MENTOR_ASSIGN_OWNER ||
     $request->type_id == Notification::$NOTIFICATION_MENTOR_ASSIGN_FRIEND) :
    ?>
    <?php $requestText = "Mentorship Assignment Request"; ?>
    <?php
   elseif ($request->type_id == Type::$SOURCE_PROJECT_MEMBER_REQUESTS) :
    ?>
