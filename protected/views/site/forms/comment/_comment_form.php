...
<div class="gb-form-body row">
 <div class="gb-error-box gb-hide col-lg-12 col-sm-12 col-xs-12 alert alert-danger alert-block">
  ...
  <div id="gb-comment-form-error-display" class="text-left row">
 ...
 <div class="form-group row gb-no-margin">
  <?php echo $form->textArea($commentModel, 'description', array('id' => 'gb-comment-form-description-input', 'class' => ' form-control col-lg-12 col-md-12 col-sm-12 col-xs-12', 'maxlength' => 150, 'placeholder' => 'Comment max 150 characters, just like twitter', 'rows' => '3')); ?>
